...
<head>
    ...
    <meta name="description"
        content="Bodhi Towns by Country Wide Homes is an upcoming pre construction townhouse development in 130 Nexus Ave, Brampton, ON.">
    <meta name="keywords"
        content="Bodhi Towns Brampton , Bodhi Towns, Bodhi Towns Brampton, Country Wide Homes, Pre construction in brampton,  townhouse in Brampton, Pre consruction towns brampton">
    <meta name="robots" content="index, follow">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="language" content="English">
    <meta name="revisit-after" content="1 days">
    <meta property="og:image" content="https://bodhitowns.com/Bodhi-Towns-1.jpg">
    <meta property="og:site_name" content="Bodhi Towns" />
...
<body>
        ...
        <nav class="navbar navbar-expand-lg fixed-top" id="navbar">
            <div class="container pt-2">
                <a href="/" class="navbar-brand">
                    <img src="images/bodhi-towns-logo.png" class="navbar-brand" alt="">
                </a>
            ...
            <div class=" hero-container">
                <div>
                    <h1 class="main-titlee pb-0  mb-0 mt-2 mt-md-0" data-aos="fade-up" data-aos-duration="2000"
                        data-aos-delay="50">Bodhi Towns</span>
                    </h1>
                    <p class=" headline-textt mt-0 pt-1 text-white" data-aos="fade-up" data-aos-duration="2000"
                        data-aos-delay="50">NOW SELLING - Freehold Townhomes in Brampton</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class=" py-md-5" id="about">
        <div class="container mt-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
            <h2
                class=" main-title pt-md-5 pb-5  fw-bold ps-3 ps-md-0 d-flex justify-content-center align-items-center text-center fs-1">
                About Bodhi Towns</h2>
            <p class=" pb-3 px-3 textt d-flex justify-content-center align-items-center">Bodhi Towns in Brampton is an
                upcoming pre construction townhouse development in 130 Nexus Ave, Brampton, ON by Country Wide Homes.
                The community is expected to complete in 2025.
            <div class="list  textt  pt-2 px-3">
                <p class="mybot pb-md-0 pb-0 ">
                    Builder: Country Wide Homes
                </p>

                <p class="mybot pb-md-0 pb-0 ">
                    Address: 130 Nexus Ave, Brampton, ON.
                </p>
                <p class="mybot pb-md-0 pb-0 ">
                    Occupancy: 2025
                </p>
                        ...
                        <div class="container">
                            <div class="carousel-wrapper">
                                <div class="owl-carousel owl-theme">
                                    <div class="item afte"><img src="images/Bodhi-Towns-2.jpg" class="imghei"
                                            alt="Bodhi Towns Brampton"></div>
                                    <div class="item afte"><img src="images/Bodhi-Towns-3.jpg" class="imghei"
                                            alt="Bodhi Towns Brampton"></div>
                                    <div class="item afte"><img src="images/Bodhi-Towns-4.jpg" class="imghei"
                                            alt="Bodhi Towns Brampton"></div>
                                    <div class="item afte"><img src="images/Bodhi-Towns-5.jpg" class="imghei"
                                            alt="Bodhi Towns Brampton"></div>

                                    <div class="item afte"><img src="images/Bodhi-Towns-6.jpg" class="imghei"
                                            alt="Bodhi Towns Brampton"></div>
                                    <div class="item afte"><img src="images/Bodhi-Towns-7.jpg" class="imghei"
                                            alt="Bodhi Towns Brampton"></div>
                                    <div class="item afte"><img src="images/Bodhi-Towns-8.jpg" class="imghei"
                                            alt="Bodhi Towns Brampton"></div>
                                    <div class="item afte"><img src="images/Bodhi-Towns-9.jpg" class="imghei"
                                            alt="Bodhi Towns Brampton"></div>
        ...
        <div class="container pt-md-5 pt-5" id="location">
            ...
            <div class="py-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                <h2 class="fw-bold fs-1 mb-0 text-center justify-content-center">
                    <span class="mx-1 pb-3">Bodhi Towns - Location</span> </span>
                </h2>
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3">130 Nexus Ave,
                    Brampton, ON.</span>

                <div class="bg-white pt-3  pt-md-0 d-flex justify-content-center col ">

                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2881.0349515094244!2d-79.6581161!3d43.77213329999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b3caef813ab29%3A0x3a313acae2dd0e8c!2s130%20Nexus%20Ave%2C%20Brampton%2C%20ON%2C%20Canada!5e0!3m2!1sen!2snp!4v1696529229148!5m2!1sen!2snp"
    ...
    <section>
        <div class="container pt-md-5 pt-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                    ...
                    <div style="border:0;outline:0;padding:0; margin: 11px 9px 0;">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <a rel="nofollow"
                                    href="https://www.walkscore.com/score/130-Nexus-Avenue-Brampton--CA.dash.ON?utm_source=badge&utm_medium=responsive&utm_campaign=badge"><!--[if lte IE 8]><img src="//pp.walk.sc/badge/walk/130-Nexus-Avenue-Brampton--CA.dash.ON.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Walk Score of 130 Nexus Avenue Brampton ON Canada"><![endif]-->
                                    <!--[if gt IE 8]><img src="//pp.walk.sc/badge/walk/130-Nexus-Avenue-Brampton--CA.dash.ON.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Walk Score of 130 Nexus Avenue Brampton ON Canada"><![endif]-->
                                    <!--[if !IE]> <!-- --><img
                                        src="//pp.walk.sc/badge/walk/130-Nexus-Avenue-Brampton--CA.dash.ON.svg"
                                        ...
                                        alt="Walk Score of 130 Nexus Avenue Brampton ON Canada"><!-- <![endif]--><!--[if lte IE 8]><img src="//pp.walk.sc/badge/transit/130-Nexus-Avenue-Brampton--CA.dash.ON.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Transit Score of 130 Nexus Avenue Brampton ON Canada"><![endif]-->
                                    <!--[if gt IE 8]><img src="//pp.walk.sc/badge/transit/130-Nexus-Avenue-Brampton--CA.dash.ON.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Transit Score of 130 Nexus Avenue Brampton ON Canada"><![endif]-->
                                    <!--[if !IE]> <!-- --><img
                                        src="//pp.walk.sc/badge/transit/130-Nexus-Avenue-Brampton--CA.dash.ON.svg"
                                        style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'
                                        alt="Transit Score of 130 Nexus Avenue Brampton ON Canada"><!-- <![endif]--><!--[if lte IE 8]><img src="//pp.walk.sc/badge/bike/130-Nexus-Avenue-Brampton--CA.dash.ON.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Bike Score of 130 Nexus Avenue Brampton ON Canada"><![endif]-->
                                    <!--[if gt IE 8]><img src="//pp.walk.sc/badge/bike/130-Nexus-Avenue-Brampton--CA.dash.ON.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Bike Score of 130 Nexus Avenue Brampton ON Canada"><![endif]-->
                                    <!--[if !IE]> <!-- --><img
                                        src="//pp.walk.sc/badge/bike/130-Nexus-Avenue-Brampton--CA.dash.ON.svg"
                                        style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'
                                        alt="Bike Score of 130 Nexus Avenue Brampton ON Canada"><!-- <![endif]--></a>
                            </div>
                        </div>
                        <p
                            ...
                            <a rel="nofollow"
                                ...
                                target="_blank"
                                href="https://www.walkscore.com/CA-ON/Brampton?utm_source=badge&utm_medium=responsive&utm_campaign=badge">Explore
                                Brampton on Walk Score</a><img style="visibility: hidden;" width=1 height=1
            ...
            <div class="pt-4 ">
                <span
                    class="small-text text-center d-flex justify-content-center custom-underline pb-3 textt px-2">(Bodhi
                    Towns)
                    130 Nexus Avenue has a Walk Score of 62 out of 100. This location is Somewhat Walkable so some
                    errands can be accomplished on foot.

                    This location is in Brampton. The closest park is Claireville Conservation Area.

                    This location is in Brampton. Nearby parks include Mount Pleasant Village Square and Fletcher's
                    Parkette.
    ...
    <section data-aos="fade-up">
        <div class="container pt-md-5 pt-5" id="location">
            ...
            <div class="py-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                ...
                <span
                    class="small-text text-center d-flex justify-content-center align-items-center custom-underline pb-3 px-2">Walk
                    around the neighbourhood near Bodhi Towns</span>

                <div class="p-1  d-flex justify-content-center">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!4v1696529801348!6m8!1m7!1sePwRnALUFFfgJYs8WfcBxQ!2m2!1d43.77178026863833!2d-79.657525024396!3f329.4424690191154!4f5.350669667993088!5f0.4000000000000002"
                        width="95%" height="550" style="border:0;" allowfullscreen="" loading="lazy"
                        referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
    ...
    <section data-aos="fade-up">
        <div class="container pt-md-5" id="location">
            <div class="pt-md-5 "></div>
            <div class="pt-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                <h2 class="fw-bold fs-1 mb-0 text-center justify-content-center" data-aos="fade-up">
                    <span class="mx-1 pb-3">Site Plan - Bodhi Towns</span> </span>
                </h2>
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 px-2">A Closer
                    Look at Bodhi Towns' Community Design</span>
            </div>

            <img src="images/CW_Bodhi_Site_Plan_Legal_01_s_34dcaceeb7.jpg" class="img-fluid imgheii"
                alt="Bodhi Towns siteplan ">
        </div>
    </section>
    ...
    <section data-aos="fade-up">
        <div class="container pt-md-5 pt-5" id="location">
            ...
            <div class="pt-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                <h2 class="fw-bold fs-1 mb-0 text-center justify-content-center" data-aos="fade-up">
                    <span class="mx-1 mb-0">Bodhi Townhome Living - Amenities</span> </span>
                </h2>
                <span class="text-center d-flex justify-content-center mx-widthh pb-4 px-2">A Tour of Bodhi Townhome
                    Living's Exclusive Amenities</span>
            </div>

            <div class="d-flex justify-content-center align-items-center">
                <iframe width="850" height="440" src="https://www.youtube.com/embed/IvpvaMC3V3I?si=yny4O3hPCcPS9mlc"
                        ...
                        <form action="./contactForm.php" method="POST">
                            ...
                            <div class="row ">
                                <p class=" text-muted sm-text text-center mt-0 ">*I consent to receive future
                                    communications about Bodhi Towns. I understand I can opt out at anytime by sending
                                    an email.</p>
                            </div>
                            <div class="row ">
    ...
    <footer class="footerr py-5 mb-4 ">
        <div class="container ">
            <div
                class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5  d-flex justify-content-center align-items-center">
                <div class="col-md-5 my-3 fotwidth center-sm px-4 px-md-0 ">
                    <p class=" ">
                    <h2 class="navbar-brand-foot fs-4"><a href="https://homebaba.ca/brampton/bodhi-towns"
                            target="_blank" class="text-dark text-decoration-none">Bodhi Towns </a></h2>
                    </p>
                    <span class=" mx-widthh">
                        ...
                        those under contract with another brokerage. All inquiries will go to Sadhana Sangli, Sales
                        Representative from Elixir Real Estate Brokerage. Email : sadhana@elixirrealestate.ca</span>
                ...
                <div class="col-md-4 py-5 center-sm px-md-5 px-5 d-flex justify-content-center align-items-center">
                    <div>
                        <h5 class="text-dark fw-bold  mb-3 ">About Bodhi Towns</h5>
                ...
                <div
                    ...
                    <img src="images/Countrywide-logo.webp" class="img-fluid footer-logo " alt="Country Wide Homes ">
            ...
            <div class="list mt-5 pt-5 d-md-none d-block center-sm px-4 ">
                <p class=" fw-bold">
                    <a href="https://condomonk.ca/brampton" target="_blank " class="text-dark text-decoration-none ">
                        <strong>Pre construction homes in Brampton</strong> </a>
                </p>
        ...
        $(document).ready(function () {
            ...
            owl.on('mousewheel', '.owl-stage', function (e) {
                if (e.originalEvent.deltaY > 0) {
                    owl.trigger('prev.owl.carousel'); // Trigger previous slide on scroll up
                } else {
                    owl.trigger('next.owl.carousel'); // Trigger next slide on scroll down
                }
                e.preventDefault();
            });
